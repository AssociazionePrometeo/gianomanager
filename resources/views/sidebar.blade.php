...
<div class="sidebar-content">
    ...
    <nav class="sidebar-navigation">
        ...
        <ul>
            ...
            <li><a href="{{ route('subscriptions.index') }}"><i class="material-icons">star</i> {{ trans_choice('models.subscription', 2) }}</a></li>
        </ul>

        <?php $u = Auth::user(); ?>
        @if($u->can('view', App\Subscription::class)
            or $u->can('view', App\Resource::class)
        ...
        <ul class="admin-navigation">
            @can('view', App\Subscription::class)
            <li><a href="{{ route('admin.subscriptions.index') }}"><i class="material-icons">star</i>{{ trans_choice('models.subscription', 2) }}</a></li>
            @endcan
